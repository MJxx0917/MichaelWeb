        ...
        <Typewriter
          options={{
            strings: [
              ...
              "Primary areas of focus are web and mobile app development",
              "Main research area is machine learning by using Python",
              "A Master Student At Auckland University Of Technology",
            ],
            autoStart: true,
            loop: true,
          }}
